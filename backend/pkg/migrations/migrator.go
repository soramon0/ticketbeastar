...
func NewDbCommand(db *bun.DB) *cli.Command {
		...
		Subcommands: []*cli.Command{
			...
			},
			{
				...
				Subcommands: []*cli.Command{
					{
						Name:  "load",
						Usage: "load all fixtures",
						Action: func(c *cli.Context) error {
							if utils.GetStageStatus() != "dev" {
								return fmt.Errorf("cannot use fixtures in production")
							}
							...
							dir := filepath.Join(cwd, "pkg", "migrations", "fixtures")
							...
							db.RegisterModel((*models.User)(nil), (*models.Concert)(nil), (*models.Ticket)(nil), (*models.Order)(nil))
